            ...
            <div class="left-block">
                ...
                <div class="left-col-2">
                    <div class="page-tab clearfix">
                        <div class="page-tab-res clearfix">
                            <div id="parentHorizontalTab">
                                <ul class="resp-tabs-list hor_1 change-color-code">
                                    <li class="border-l resp-tab-item hor_1 resp-tab-active"><a href="javascript:viod(0)" id="tab-list-1">Press Release</a>
                                    </li>
                ...
                <div class="left-col-2">
                    ...
                    <div class="bg-white-tender">
                        ...
                        <div class="list-content">
                            {{ $tender_managements->title_name_en }} - File type
